...
const listOfQuestions =[
    ...
    questionNumber: 3,
    question: "String values must be enclosed within _____ when being assigned into variables.",
    answers: {
        a: "Commas",
        b: "Curly Brackets",
        c: "Quotes",
...
1. Initialize all variables and scores
2. Hide startButton when start is clicked
3. Begin timer
*/  
